...
Route::group(['middleware' => 'auth', 'prefix' => 'admin'],function(){
  ...
  #Produtos 
	Route::get('/produtos', array('uses' => 'ProdutoController@postCreate'))->name('admin.produtos.create');

  #Search

	Route::get('/search', array('uses' => 'QueryController@getSearchVendas'))->name('admin.search.vendas');
	Route::get('/search', array('uses' => 'QueryController@getSearchTransacoes'))->name('admin.search.transacoes');
	Route::get('/search', array('uses' => 'QueryController@getSearchClientes'))->name('admin.search.clientes');
	Route::get('/search', array('uses' => 'ProdutoController@getFilterComissions'))->name('admin.filter.comissions');

  #Comissoes
	Route::get('/comissoes', array('uses' => 'ComissoesController@getComissoes'))->name('admin.comissoes.comissoes');
  #Clientes

	Route::get('/clientes', array('uses' => 'ClienteController@getClientes'))->name('admin.clientes.clientes');
	Route::get('/clientes', array('uses' => 'ClienteController@getHistoricoPedidos'))->name('admin.clientes.historico-pedidos');

  //   ));
    Route::resource('fda','FdaController', array('as' => 'admin'));
    ...
    #Franqueados
	Route::resource('franqueado','FranqueadoController', array('as' => 'admin'));
	...
	Route::resource('comissoes','ComissoesController',['except'=>['update','edit','show'], 'as'=>'admin']);
	Route::resource('royalties','RoyaltiesController',['only'=>['create','store','index','destroy'], 'as'=>'admin']);
  ...
  // Checagem
	Route::get('/checagem', array('uses' => 'ChecagemController@postCreatet'))->name('admin.checagem.create');
	Route::get('/checagem', array('uses' => 'ChecagemController@getView'))->name('admin.checagem.view');
	Route::get('/checagem', array('uses' => 'ChecagemController@postCancelar'))->name('admin.checagem.cancelar');
	Route::get('/checagem', array('uses' => 'ChecagemController@getConsultaPedido'))->name('admin.checagem.consulta');
	Route::get('/checagem', array('uses' => 'ChecagemController@getListarPedido'))->name('admin.checagem.listar');
