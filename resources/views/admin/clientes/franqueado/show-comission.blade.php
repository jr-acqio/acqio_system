...
<head>
  ...
  <style media="print">
    .breadcrumb, .title-action, .footer{
      display: none;
    }
    h1,h2,h3,h4,h5,h6{
      border-bottom: none;
        ...
        <div class="row border-bottom white-bg page-heading">
          ...
          <div class="col-lg-4">
            <div class="title-action">
              <a href="#" class="btn btn-primary"><i class="fa fa-print"> Imprimir Comissão</i></a>
              <button type="button" class="btn btn-primary print"><i class="fa fa-print"></i> Imprimir Comissão</button>
            </div>
          </div>
        </div>
              ...
              <div class="animated fadeInRight">
                <div class="ibox-content p-xl">
                  <div class="row">
                    <div class="col-sm-6">
                      <p>
                        <!-- <span><strong>Total de POS:</strong></span> -->
                      </p>
                    </div>
