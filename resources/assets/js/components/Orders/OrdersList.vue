				...
				<div class="row">
					<div class="col-lg-12">
						<div class="form-group">
							<button class="btn btn-default">Realizados <i class="glyphicon glyphicon-ok pg"></i></button>
							<button class="btn btn-default">Rejeitados <i class="glyphicon glyphicon-remove rejected"></i></button>
						</div>
