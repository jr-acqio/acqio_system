														...
														<table class="table table-striped table-hover">
															...
															<tbody>
																<tr v-for="(order, key) in filterByFda((orders.orders_fda),filterInput)">
																	...
																	<td>
																		<a href="#" class="btn btn-success btn-xs" title="Pago" data-toggle="tooltip" data-placement="top" @click.prevent="approvedOrder(order,orders.orders_fda)">
														...
														<table class="table table-striped table-hover">
															...
															<tbody>
																<tr v-for="(order,key) in filterByFranq((orders.orders_fr),filterInput)">
																	...
																	<td>
																		<a href="#" class="btn btn-success btn-xs" title="Pago" data-toggle="tooltip" data-placement="top" @click.prevent="approvedOrder(order,orders.orders_fr)">
																			<i class="fa fa-thumbs-up" aria-hidden="true"></i>
																		</a>
																		<a href="#" class="btn btn-danger btn-xs" title="Não pago" data-toggle="tooltip" data-placement="top">
																			<i class="fa fa-thumbs-down" aria-hidden="true"></i>
